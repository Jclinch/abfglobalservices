    ...
    <footer className="bg-blue-950 text-white py-12 px-4">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300">Lekki Phase 1, Lagos, Nigeria</p>
          <p className="text-sm text-gray-300 mt-1">Phone: <a href="tel:+2348012345678" className="text-yellow-400">+234 801 234 5678</a></p>
